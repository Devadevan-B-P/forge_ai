...
const ScrollStack = ({
  ...
  // Cached layout coordinates to prevent layout thrashing and jitter/vibration
  ...
  const calculateOffsets = useCallback(() => {
    ...
    // Reset styles temporarily to measure clean, untransformed layout offsets
    ...
    if (endElement) {
      if (useWindowScroll) {
        ...
        endElementOffsetRef.current = (endElement as HTMLElement).offsetTop;
      }
    }

    // Restore cached styles immediately after measuring
...
const ScrollStackMemo = React.memo(ScrollStack);
export default ScrollStackMemo;
