...
// Custom interface for uniforms type safety
interface ShaderUniforms {
  ...
  uMouse: { value: Float32Array | number[] };
...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      if (program) {
        (program.uniforms as unknown as ShaderUniforms).uResolution.value = [gl.canvas.width, gl.canvas.height, gl.canvas.width / gl.canvas.height];
      }
    }
    ...
    function update(time: number) {
      ...
      const uniforms = program.uniforms as unknown as ShaderUniforms;
      ...
      if (enableMouseInteraction) {
        ...
        (uniforms.uMouse.value as Float32Array)[0] = 0.5;
        (uniforms.uMouse.value as Float32Array)[1] = 0.5;
      }
